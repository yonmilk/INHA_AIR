...
public class TicketingRoundTripGoingFormTEST extends JFrame implements ActionListener {
	private static TicketingRoundTripGoingFormTEST a;
	// Title 및 사이즈 설정
...
//					String SelectedFliCo = "IH8985";
	...
	public static void main(String[] args) {
		new TicketingRoundTripGoingFormTEST();
		a = new TicketingRoundTripGoingFormTEST();
		a.roundtrip();
