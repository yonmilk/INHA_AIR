...
public class TicketingRoundTripComingFormX extends JFrame implements ActionListener {
	// Title 및 사이즈 설정
...
//		private TicketingRoundTripGoingForm rtg1;
	...
	public TicketingRoundTripComingFormX() {
		setTitle(title);
...
//					conn.close();
	...
	public static void main(String[] args) {
		new TicketingRoundTripComingFormX();
	}
...
//			intPayGo = Integer.parseInt(payGo);
			finaltotalPay = intPrePrice + payGo;
