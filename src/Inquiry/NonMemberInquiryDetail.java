...
public class NonMemberInquiryDetail extends JFrame implements ActionListener {
	// Title 및 사이즈 설정
...
//		lblInquiryTitle.setForeground(crNavy);;
		...
		lblSeat.setBounds(780, 10, 80, 20);
