...
public class MinuReserve extends JFrame{
	...
	public MinuReserve(String title, int width, int height) {
		setTitle(title);
		...
		jp1 = new JPanel();
		jpdep = new JPanel();
		jpdep.setLayout(new GridLayout(1, 2));
	...
	public static void main(String[] args) {
		new MinuReserve("INHA AIR", 400, 400);
	}
